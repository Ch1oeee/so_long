...
/*   Updated: 2025/02/27 13:45:24 by cmontaig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_textures(t_game *game)
{
	...
	game->textures.wall = mlx_xpm_file_to_image(game->mlx, "assets/Tree.xpm",
	...
	game->textures.exit = mlx_xpm_file_to_image(game->mlx,
			...
			&game->textures.img_height);
	game->textures.grass = mlx_xpm_file_to_image(game->mlx, "assets/Grass.xpm",
			&game->textures.img_width, &game->textures.img_height);
	game->textures.player = mlx_xpm_file_to_image(game->mlx, "assets/Mako.xpm",
			&game->textures.img_width, &game->textures.img_height);
...
void	draw_basic_tiles(t_game *game, int x, int y, char tile)
{
	if (tile == '1')
		...
		ennemi_walking_animation(game, x, y);
	else if (tile == 'C')
		mlx_put_image_to_window(game->mlx, game->win,
